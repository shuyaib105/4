...
import { Brain, Lightbulb, Mail, Rocket, Fingerprint, Globe, UserCircle, Info, Shield } from 'lucide-react';
    ...
    <div className="bg-[#FFFDF5] text-foreground antialiased">
      ...
      <main className="container mx-auto px-6 -mt-10 relative z-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            {/* Founder Profile */}
            <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-yellow-100 hover:-translate-y-2 hover:shadow-lg transition-all duration-500">
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="flex justify-center md:justify-start gap-4">
                            <a href="mailto:mdshuyaibislam5050@gmail.com" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-red-500 hover:text-white transition-all"><Mail /></a>
                            <a href="https://github.com/shuyaib105" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-black hover:text-white transition-all"><FaGithub /></a>
                            <a href="https://t.me/shu_yaib" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-blue-500 hover:text-white transition-all"><FaTelegramPlane /></a>
                        </div>
                    </div>
                </div>
            </div>
              ...
              <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-yellow-100 hover:-translate-y-2 hover:shadow-lg transition-all duration-500">
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <div className="flex justify-center md:justify-start gap-4">
                            <a href="mailto:frostfoe@gmail.com" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-red-500 hover:text-white transition-all"><Mail /></a>
                             <a href="https://t.me/frostfoe" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-blue-500 hover:text-white transition-all"><FaTelegramPlane /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {/* Vision & Mission */}
        <div className="bg-white rounded-[4rem] p-12 shadow-2xl border border-yellow-50 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-bold font-tiro-bangla">লক্ষ্য</h3>
                    <p className="text-sm text-gray-500 leading-relaxed font-tiro-bangla">শিক্ষার্থীদের ডিজিটাল যুগে প্রতিযোগিতামূলক করার জন্য সিলেবাসের বাইরেও জ্ঞান আহরণে সহায়তা করা।</p>
                </div>
                <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-bold font-tiro-bangla">স্বকীয়তা</h3>
                    <p className="text-sm text-gray-500 leading-relaxed font-tiro-bangla">আমরা বিশ্বাস করি প্রতিটি শিক্ষার্থী অনন্য। তাই তাদের মেধা বিকাশে আমরা গতানুগতিক পদ্ধতির ঊর্ধ্বে কাজ করি।</p>
                </div>
                <div className="space-y-4">
                    ...
                    <h3 className="text-xl font-bold font-tiro-bangla">ভবিষ্যৎ</h3>
                    <p className="text-sm text-gray-500 leading-relaxed font-tiro-bangla">আগামীর স্মার্ট বাংলাদেশ বিনির্মাণে দক্ষ জনবল তৈরিতে একটি পূর্ণাঙ্গ ই-লার্নিং হাব হয়ে ওঠা।</p>
                </div>
            </div>
        </div>
